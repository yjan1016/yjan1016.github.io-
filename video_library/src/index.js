(function($) {
    ...
    var videoSpeed = 1;
    var videoListAll = new Array(//'./src/1.mp4',
        //'https://v6.stream.tencentmusic.com/0b53juaaoaaaw4ai3umjm5r2ctoda5gqabya.f160030.mp4?dis_k=906f9e63e1adc3b14372e91952c167a7&dis_t=1674540425&local=1&fromtag=1061014',
        './src/3.mp4',
        /*'./src/4.mp4',
        './src/5.mp4',
        './src/6.mp4',
        ...
        './src/18.mp4',
        './src/19.mp4');
        /*⚠此处注意,最后一个一定不要有包括但不限于逗号的东西，注释都不行，一定!*/
    var danId = 0;
    var clickFlag = null;
    var vedioError = null;
    function qiehuan(){
